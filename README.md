...
Our challenge is to build out this intro component and get it looking as close to the design as possible.
...
- Create the background shape using  Css code
...
7. Started creating with Semantic HTML5 markup
8.  Added CSS styles
9.  Added basic functionality using Javascript
